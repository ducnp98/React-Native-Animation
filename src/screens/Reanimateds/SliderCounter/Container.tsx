...
const Container = () => {
  ...
  return (
    <Animated.View className='h-20 w-52 bg-slate-900 rounded-full items-center justify-evenly flex-row' style={rButtonStyle}>
      <Animated.View style={rPlusMinusIconStyle}>
        <MyIcon name="minus" color={'white'} size={20} />
      </Animated.View>
      <Animated.View style={rCloseIconStyle}>
        <MyIcon name="close" color={'white'} size={20} />
      </Animated.View>
      <Animated.View style={rPlusMinusIconStyle}>
        <MyIcon name="plus" color={'white'} size={20} />
      </Animated.View>
      <View
        style={{
      ...
      >
        <PanGestureHandler onGestureEvent={onPanGestureEvent}>
          <Animated.View className='h-16 w-16 bg-slate-600 rounded-full absolute justify-center items-center' style={rStyle}>
